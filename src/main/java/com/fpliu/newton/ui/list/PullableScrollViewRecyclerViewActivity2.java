    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ItemAdapterEx<T, H> itemAdapter = new ItemAdapterEx<T, H>(null) {
            ...
            public H onCreateHeaderViewHolder(ViewGroup viewGroup, int viewType, View headerView) {
                return PullableScrollViewRecyclerViewActivity2.this.onCreateHeaderViewHolder(viewGroup, viewType, headerView);
            }

            @Override
            public H onCreateFooterViewHolder(ViewGroup viewGroup, int viewType, View footerView) {
                return PullableScrollViewRecyclerViewActivity2.this.onCreateFooterViewHolder(viewGroup, viewType, footerView);
            }

            @Override
            public H onCreateViewHolder2(ViewGroup viewGroup, int viewType) {
                return PullableScrollViewRecyclerViewActivity2.this.onCreateViewHolder(viewGroup, viewType);
            }

            @Override
            public void onBindViewHolder(H holder, int position, T item) {
                PullableScrollViewRecyclerViewActivity2.this.onBindViewHolder(holder, position, item);
            }
        };
        if (headerView != null) {
