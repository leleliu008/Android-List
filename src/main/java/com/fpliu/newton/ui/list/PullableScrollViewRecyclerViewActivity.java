 ...
 */
public abstract class PullableScrollViewRecyclerViewActivity<T, H extends ItemViewHolderAbs> extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setItemAdapter(new ItemAdapter<T, H>(null) {
            ...
            public H onCreateViewHolder(ViewGroup parent, int viewType) {
                return PullableScrollViewRecyclerViewActivity.this.onCreateViewHolder(parent, viewType);
            }
