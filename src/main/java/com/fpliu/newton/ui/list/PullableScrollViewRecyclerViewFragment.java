 ...
 */
public abstract class PullableScrollViewRecyclerViewFragment<T, H extends ItemViewHolderAbs> extends LazyFragment
        implements IPullable<T, ScrollView>, IRecyclerView<T, H>,
        OnItemClickListener<T, H>, RefreshOrLoadMoreCallback<ScrollView> {
    ...
    protected void onCreateViewLazy(BaseView baseView, Bundle savedInstanceState) {
        ...
        setItemAdapter(new ItemAdapter<T, H>(null) {
            ...
            public H onCreateViewHolder(ViewGroup parent, int viewType) {
                return PullableScrollViewRecyclerViewFragment.this.onCreateViewHolder(parent, viewType);
            }
